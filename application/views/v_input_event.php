      ...
      <!-- Banner -->
        <section id="banner">
          <div class="content">
           ...
           <h2>Input Rundown Acara</h2>
<div class="container">
        <div class="col-md-4 col-md-offset-4">
          <form class="form-signin" action="<?php echo base_url().'index.php/Admin/input_aksi_event' ?>" method="post">
            <table>
            <tr>
            <td><b>JAM ACARA</b></td>
            <td> 
            <input type="text" name="jam_acara" class="form-control" required autofocus></td></tr>

            <tr>
            <td><b>KETERANGAN ACARA</b></td>
            <td> 
            <input type="text"  name="keterangan_acara" class="form-control" required autofocus></td></tr>

            <tr>
            <td><b>PEMBAWA ACARA</b></td>
            <td> 
            <input type="text" id="id" name="pembawa_acara" class="form-control" required autofocus></td></tr>

            <tr>
            <td><b>PENANGGUNG JAWAB ACARA</b></td>
            <td> 
            <input type="text" id="id" name="penanggungjawab_acara" class="form-control" required autofocus></td></tr>

            
          </table>
            <br>
             <input style="background-color: #e44c65 " type="submit" class="btn btn-primary" value=" &nbsp Tambah &nbsp">
          </form>
        </div>
        </div> <!-- /container -->
      </div>
