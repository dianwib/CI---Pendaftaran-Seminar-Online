...
<?php foreach($user as $data){ 
    ...
    echo "<tr>";
     ...
     echo "<td>". $data->password ."</td>";
        echo "<td>".anchor('Admin/aktivasi_member/'.$data->id,'Aktivasi')."||".anchor('Admin/hapus_member/'.$data->id,'Hapus')."</td>";
        echo "</tr>";  
       }
...
<?php echo "<br><i> Total peserta yang belum terverifikasi adalah: <b>".$total." Orang.</b></i>"; ?>
